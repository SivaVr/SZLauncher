...
public class Homescreen extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Icon.setImageDrawable(LauncherActivity.getActivityIcon(this.getContext(), "com.android.chrome", "com.google.android.apps.chrome.Main"));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.icon:
                Intent launchIntent = LauncherActivity.baseContext.getPackageManager().getLaunchIntentForPackage("com.android.chrome");
